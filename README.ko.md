...
영문 `README.md`를 기준 문서로 두고, 한국어 문서는 프로젝트 변경 시 약간 늦게 갱신될 수 있습니다.
...
GitHub는 README 언어를 자동 전환해 주지 않아서, 현재는 아래처럼 단순하게 구성합니다.

- 기본 문서를 `README.md`로 유지
- 한국어 번역은 `README.ko.md`로 유지
- 각 README 상단에는 English / 한국어 링크만 배치

나중에 필요해지면 다른 언어 문서를 다시 추가할 수 있습니다.
